...
namespace CafeteriaManagement.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        {
            if (!_roleManager.RoleExistsAsync(SD.Role_Cashier).GetAwaiter().GetResult())
            {
            ...
            Input = new()
            {
                RoleList = _roleManager.Roles.Select(x => x.Name).Select(u =>
                new SelectListItem
                {
                    Text = u,
                    Value = u
